// ======================================================================
// \title  NaviTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Navi/Top/NaviTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <Navi/Top/NaviPacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Navi_blockDrv::WARN, PingEntries::Navi_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Navi_tlmSend::WARN, PingEntries::Navi_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Navi_cmdDisp::WARN, PingEntries::Navi_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Navi_cmdSeq::WARN, PingEntries::Navi_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Navi_eventLogger::WARN, PingEntries::Navi_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Navi_fileDownlink::WARN, PingEntries::Navi_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Navi_fileManager::WARN, PingEntries::Navi_fileManager::FATAL, "fileManager"},
    {PingEntries::Navi_fileUplink::WARN, PingEntries::Navi_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Navi_prmDb::WARN, PingEntries::Navi_prmDb::FATAL, "prmDb"},
    {PingEntries::Navi_rateGroup1::WARN, PingEntries::Navi_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Navi_rateGroup2::WARN, PingEntries::Navi_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Navi_rateGroup3::WARN, PingEntries::Navi_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(NaviPacketsPkts, NaviPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name Navi
namespace Navi {
