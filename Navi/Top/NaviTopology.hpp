// ======================================================================
// \title  NaviTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NAVI_NAVITOPOLOGY_HPP
#define NAVI_NAVITOPOLOGY_HPP
// Included for access to Navi::TopologyState and Navi::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Navi/Top/NaviTopologyDefs.hpp>

// Remove unnecessary Navi:: qualifications
 ...
 * Navi::TopologyState see: NaviTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Navi::TopologyState see: NaviTopologyDefs.hpp.
 *
