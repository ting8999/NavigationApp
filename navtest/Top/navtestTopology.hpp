// ======================================================================
// \title  navtestTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NAVTEST_NAVTESTTOPOLOGY_HPP
#define NAVTEST_NAVTESTTOPOLOGY_HPP
// Included for access to navtest::TopologyState and navtest::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <navtest/Top/navtestTopologyDefs.hpp>

// Remove unnecessary navtest:: qualifications
 ...
 * navtest::TopologyState see: navtestTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type navtest::TopologyState see: navtestTopologyDefs.hpp.
 *
