...
#include <navtest/Top/navtestTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    navtest::setupTopology(inputs);
    navtest::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    navtest::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
