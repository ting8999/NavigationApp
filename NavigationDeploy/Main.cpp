...
#include <NavigationDeploy/Top/NavigationDeployTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    NavigationDeploy::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    NavigationDeploy::TopologyState inputs;
    ...
    NavigationDeploy::setupTopology(inputs);
    NavigationDeploy::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    NavigationDeploy::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
