// ======================================================================
// \title  NavigationDeployTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NAVIGATIONDEPLOY_NAVIGATIONDEPLOYTOPOLOGY_HPP
#define NAVIGATIONDEPLOY_NAVIGATIONDEPLOYTOPOLOGY_HPP
// Included for access to NavigationDeploy::TopologyState and NavigationDeploy::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <NavigationDeploy/Top/NavigationDeployTopologyDefs.hpp>

// Remove unnecessary NavigationDeploy:: qualifications
 ...
 * NavigationDeploy::TopologyState see: NavigationDeployTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type NavigationDeploy::TopologyState see: NavigationDeployTopologyDefs.hpp.
 *
